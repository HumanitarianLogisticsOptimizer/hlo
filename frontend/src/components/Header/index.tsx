...
import LogoIcon from '../../images/logo/HLO.svg';
import DarkModeSwitcher from './DarkModeSwitcher';
import { AuthContext } from '../HLO/AuthProvider';// Adjust the path as necessary
        ...
        <div className="flex items-center gap-3 2xsm:gap-7">
          ...
          {!auth && (
            <>
              <Link
                to='/auth/signin'
                className='hidden sm:block rounded-lg bg-primary p-3 font-medium text-white hover:bg-opacity-90'
              >
                Login
              </Link>
            </>
